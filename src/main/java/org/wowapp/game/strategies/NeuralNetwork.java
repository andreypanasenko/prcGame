...
public class NeuralNetwork {
	...
	public static NeuralNetwork cloneNeuralNetwork(NeuralNetwork origin) {
		NeuralNetwork newNetwork = new NeuralNetwork(origin.inputCount,
				origin.hiddenCount,
				origin.outputCount,
				origin.learnRate,
				origin.momentum);
		
		System.arraycopy(origin.fire, 0, newNetwork.fire, 0, newNetwork.neuronCount);
		System.arraycopy(origin.matrix, 0, newNetwork.matrix, 0, newNetwork.weightCount);
		System.arraycopy(origin.matrixDelta, 0, newNetwork.matrixDelta, 0, newNetwork.weightCount);
		System.arraycopy(origin.thresholds, 0, newNetwork.thresholds, 0, newNetwork.neuronCount);
		System.arraycopy(origin.errorDelta, 0, newNetwork.errorDelta, 0, newNetwork.neuronCount);
		System.arraycopy(origin.error, 0, newNetwork.error, 0, newNetwork.neuronCount);
		System.arraycopy(origin.accThresholdDelta, 0, newNetwork.accThresholdDelta, 0, newNetwork.neuronCount);
		System.arraycopy(origin.accMatrixDelta, 0, newNetwork.accMatrixDelta, 0, newNetwork.weightCount);
		System.arraycopy(origin.thresholdDelta, 0, newNetwork.thresholdDelta, 0, newNetwork.neuronCount);
		return newNetwork;
	}
}
